...
for(user_a in 1:104)
{
  ...
  for(user_b in 1:104)
  {
    ...
    if(user_a > user_b)
    {
      ...
      jacard_distance_a_b <- 1 - (sum(linear_model_betas[user_a,] * logistic_model_betas[user_b,]) / sum(logistic_model_betas[user_a,] + logistic_model_betas[user_b,] - (logistic_model_betas[user_a,] * logistic_model_betas[user_b,])))
...
adjacency_neighbor <- labels[which(adjacency_matrix[which(labels == person_of_interest),] == max(adjacency_matrix[which(labels == person_of_interest),]))]

manhattan_neighbor <- labels[which(manhattan_distance_matrix[which(labels == person_of_interest),] == min(manhattan_distance_matrix[which(labels == person_of_interest),][manhattan_distance_matrix[which(labels == person_of_interest),] > 0]))]

euclidean_neighbor <- labels[which(euclidean_distance_matrix[which(labels == person_of_interest),] == min(euclidean_distance_matrix[which(labels == person_of_interest),][euclidean_distance_matrix[which(labels == person_of_interest),] > 0]))]
             
cosine_neighbor <- labels[which(cosine_distance_matrix[which(labels == person_of_interest),] == min(cosine_distance_matrix[which(labels == person_of_interest),][cosine_distance_matrix[which(labels == person_of_interest),] > 0]))]
             
jaccard_neighbor <- labels[which(jaccard_distance_matrix[which(labels == person_of_interest),] == min(jaccard_distance_matrix[which(labels == person_of_interest),][jaccard_distance_matrix[which(labels == person_of_interest),] > 0]))]
...
rownames(fcm_res[fcm_res$V12==6,])
```
